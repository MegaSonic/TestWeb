...
var TVideo2D = Object.subclass('users.TVideo2D',
  'properties',{
    fileName: null,
    videoready: false,
    video: null,
  ...
  'initialize',{
    initialize: function(fName, onComplete){
      this.fileName = fName; 
    ...
    play: function(){ this.video.play(); this.isPlaying = true; },
    pause: function(){this.video.pause(); this.isPlaying = false; },
    startStop: function(){if(this.isPlaying)this.pause(); else this.play();},
  }
);
