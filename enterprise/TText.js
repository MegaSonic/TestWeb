...
var TextEditRect = TRectangle.subclass("users.TextEditRect",
"properties", {
  isText: true,
  textTexture: null,
  eventStrings: [],
...
"initialize", {
  ...
  initialize: function($super, parent, onComplete, onFilterKey, w, h, resolution, wsegs, hsegs) {
...
"text modification", {
  ...
  insertText(string, textPos) {
    if (!textPos) textPos = this.cursorPosition;
