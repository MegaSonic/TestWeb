...
var TBottleLine = TObject.subclass('users.TBottleLine',
	'properties',{
		min: null,
		max: null
	},
	'initalize',{
		initialize: function(parent, onComplete, bottleMesh, min, max){
				this.min = min;
				this.max = max;
...
var TBottleChart = TObject.subclass('users.TBottleChart',
	'properties',{
		bottles: null, // array of bottle objects
		min: null,
		max: null,
		clipPlanes: null,
		transformedPlanes: null,
		graphPaper: null,
		scaleY:null,
		tStart: null,
		tEnd: null,
	...
	'initialize',{
		initialize: function($super, parent, onComplete, bottles, tStart, tEnd, xLabel, yLabel){
...
var TGraphPaper = TObject.subclass('users.TGraphPaper',
	'properties',{
		texture: null
	},
	'initialize',{
		initialize: function(parent, onComplete, ext, texture){
